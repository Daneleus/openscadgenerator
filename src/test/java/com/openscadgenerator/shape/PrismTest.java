...
class PrismTest {
    ...
    void defaultValues() {
        ...
        FileUtil.writeScadStringToFile(scadString, "src\\test\\samples", "prism_dafault");
    ...
    void diameter() {
        ...
        FileUtil.writeScadStringToFile(scadString, "src\\test\\samples", "prism_diameter");
    ...
    void height() {
        ...
        FileUtil.writeScadStringToFile(scadString, "src\\test\\samples", "prism_height");
    ...
    void points() {
        ...
        FileUtil.writeScadStringToFile(scadString, "src\\test\\samples", "prism_points");
